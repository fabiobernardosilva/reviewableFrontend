...
export class Identification extends React.Component<IdentificationProps, IdentificationState>{
...
<strong><span style={{ color: 'red' }}>*</span></strong>required</p>
            ...
            <p><span className="checkbox"></span> I have read and accept reviewable's <a href=''>Terms and Conditions</a> and <a href=''>Privacy Policy</a>.</p>
